...
- **Filename:** `tasks-[feature-name].md` such as `tasks-user-profile-editing.md`
...
8. **Save Task List:** Save the generated document in `/docs/development/tasks/` with the filename `tasks-[feature-name].md`, where `[feature-name]` describes the main feature or task being implemented.
...
- `lib/utils/helpers.ts` - Brief description.
...
- [ ] 0.0 Create feature branch
  - [ ] 0.1 Create and checkout a new branch for this feature such as `git checkout -b feature/[feature-name]`
